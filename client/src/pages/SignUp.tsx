...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-purple-800 flex items-center justify-center p-3 py-4">
      ...
      <Card className="w-full max-w-md bg-white/95 backdrop-blur-sm border-0 shadow-2xl relative z-10 my-2">
        ...
        <CardContent className="space-y-3 px-4 pb-4">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-9 border-2 hover:bg-gray-50 transition-colors text-sm"
